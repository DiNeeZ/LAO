...
function initDomik() {
    ...
    var lpSlider = $(".lp-slider .owl-carousel");
    lpSlider.owlCarousel({
        autoPlay: 3000,
        loop: true,
        margin: 10,
        singleItem: true,
    ...
    // map ------------------	
    var q = $(".map").attr("data-latitude"),
        r = $(".map").attr("data-longitude"),
        s = $(".map").attr("data-location");
    $("#map_addresses").gMap({
        latitude: q,
        longitude: r,
        zoom: 19,
...
// функция обратного вызова для обработки токена.